# Gift By : klint slyx kazuki
# Github : https://github.com/klint-405/klintss
# Fb Id    : klint slyx kazuki
###----------[ IMPORT LIBRARY ]---------- ###
...
os.system('https://www.facebook.com/profile.php?id=61557104816462')
...
8888888b    888        888   888 Y88b888     888     
888  Y88b   888        888   888  Y88888     888     
888   Y88b  888        888   888   Y8888     888     
888    Y88b 88888888 8888888 888    Y888     888     
...
def login():
    ...
    print("""
     ...
     \x1b[38;5;48m888  d8P    888        888   88888b  888     888     
     \x1b[38;5;49m888d88K     888        888   888Y88b 888     888     
     \x1b[38;5;50m8888888b    888        888   888 Y88b888     888     
     \x1b[38;5;51m888  Y88b   888        888   888  Y88888     888     
     \x1b[38;5;52m888   Y88b  888        888   888   Y8888     888     
     \x1b[38;5;53m888    Y88b 88888888 8888888 888    Y888     888     
     
========================================
Author : klint slyx kazuki
Facebook : klint slyx kazuki
Tool : fbshare
Version : 0.1
========================================

    cetak(nel(f'\n \t {H2}  FB AUTO SHARE TOOLS BRO \n\n \t\t {H2}~[{K2} T{K2}A{K2}S{K2}L{K2}I{K2}M {H2}]~',
              title=f'{P2}  {H2}[{K2} T{K2}A{K2}S{K2}L{K2}I{K2}M {K2}T{K2}E{K2}R{K2}M{K2}U{K2}X {K2}H{K2}E{K2}L{K2}P{K2}I{K2}N{K2}G {K2}Z{K2}O{K2}N{K2}E {H2}]',
    ...
    try:
        ...
        cetak(nel(f'{P2} LOGIN COMPLETE', width=24, style=f"#00FF00"));
        time.sleep(2)
        bot_share()
    except:
...
{B2} Current Date    :{H2} {hari}, {tanggal}', title=f'{P2} {H2}[ {K2}Cookie Id Information {H2}],
    ...
    cetak(
        nel(f'{H2} T{H2}A{H2}S{H2}L{H2}I{H2}M {B2}F{B2}B {O2}A{O2}U{O2}T{O2}O {N2}S{N2}H{N2}A{N2}R{N2}E {K2}S{K2}T{K2}A{K2}R{K2}T',
